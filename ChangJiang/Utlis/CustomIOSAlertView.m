...
- (id)init
{
    self = [super init];
    if (self) {
        self.frame = CGRectMake(30, 0, [UIScreen mainScreen].bounds.size.width - 60, 80);
...
- (UIView *)createDemoViewWithLoadText:(NSString *)loadText
{
    UIView *demoView = [[UIView alloc] initWithFrame:CGRectMake(0, 0,[UIScreen mainScreen].bounds.size.width - 60, 80)];
    UILabel *label = [[UILabel alloc] initWithFrame:CGRectMake(60, 10, 200, 60)];
    [label setText:loadText];
    [label setTextColor:[UIColor blackColor]];
    UIActivityIndicatorView *indicator = [[UIActivityIndicatorView alloc] initWithFrame:CGRectMake(0, 10, 60, 60)];
    [indicator setColor:[UIColor grayColor]];
    [indicator startAnimating];
    
    [demoView addSubview:indicator];
